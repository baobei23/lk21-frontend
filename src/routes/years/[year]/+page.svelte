...
<svelte:head>
	<title>Film & Series Tahun {yearParam} - LK21 Streaming</title>
	<meta name="description" content="Film dan series yang dirilis pada tahun {yearParam}. Streaming gratis dengan kualitas HD di LK21." />
</svelte:head>

<div class="mb-8">
	<nav class="mb-4">
		<a href="/years" class="text-primary-400 hover:text-primary-300">← Kembali ke Tahun</a>
	</nav>
	
	<h1 class="text-3xl font-bold mb-4">
		Film & Series Tahun {yearParam}
	</h1>
...
{:else if content.length === 0}
	<div class="text-center py-8">
		<p class="text-gray-400">
			Tidak ada {contentType === 'movies' ? 'film' : 'series'} ditemukan untuk tahun {yearParam}.
		</p>
	</div>
{:else}
	<!-- Content Grid -->
